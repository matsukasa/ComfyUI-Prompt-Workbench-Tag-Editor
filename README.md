...
Prompt Workbenchに同梱されるタグセットには、[アリス服飾店（@AliceLavli）様](https://x.com/AliceLavli) が作成されたプロンプトを、ご厚意により収録させていただきました。素敵なプロンプトをご提供いただき、本当にありがとうございます。
...
- `creator` や `source_url` を残せるため、アリス服飾店様のような提供元つきタグセットも出典を保ったまま整理できます。
